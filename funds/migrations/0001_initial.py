# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-04-01 12:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fundaccount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='funds.FundAccount')),
                ('transaction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='investors.Transaction')),
            ],
        ),
